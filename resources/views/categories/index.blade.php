...
<div class="container w-25 border p-4 rounded bg-light mt-4">
    ...
    <form  method="POST" action="{{route('categories.store')}}">
        ...
        @endif
            ...
            <label for="exampleColorInput" class="form-label text-center">Elige un color para tu categoría </label>
            ...
            <input type="submit" value="Crear categoría y ver tareas" class="btn btn-primary my-2 text-white rounded" />
        </div>
    </form>
</div>
